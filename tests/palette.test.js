...
test('gold means "you did this" and is used for nothing else', () => {
  ...
  // that met the cardio target, in Cardio trend, and a Hebrew target met this week. Opened big: a
  // personal best set in the last fortnight, and a rung of the Hebrew ladder reached.
  assert.deepEqual(gold, [
    '.bar.met > span', '.big-table td.recent', '.cardio-bars .bar.met', '.gym .pr', '.heb-num.met', '.met', '.pips.met .pip',
