...
test('mergeMind: the budget is the larger count on the same day, and the later day otherwise', () => {
  const a = emptyMind();
  const b = emptyMind();
  a.budget = { day: '2026-09-24', gemini: 10, messages: 2, pings: 1, deep: 0, lastSaid: '2026-09-24T10:00:00.000Z', geminiBlocked: false };
  b.budget = { day: '2026-09-24', gemini: 4, messages: 3, pings: 1, deep: 1, lastSaid: '2026-09-24T11:00:00.000Z', geminiBlocked: true };
  assert.deepEqual(mergeMind(a, b).budget, { day: '2026-09-24', gemini: 10, messages: 3, pings: 1, deep: 1, lastSaid: '2026-09-24T11:00:00.000Z', geminiBlocked: true });
