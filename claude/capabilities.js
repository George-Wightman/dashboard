...
const TOPICS = {
  ...
  checkins: { purpose: "What George said about each task as he ticked it, or when its block passed unticked (typed or spoken, tidied by Gemini)",
    reads: ['catchup [days]', 'checkins [days]'],
    note: 'Asked by the app on a tick and by the planner on a missed block; nothing to set up. catchup moves its marker; catchup <days> and checkins only read.' },
